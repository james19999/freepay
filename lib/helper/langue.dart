...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'fr_FR': {
          ...
          "Taille (1 Mo)":"Taille (1 Mo)",
          "Destinataire":"Destinataire",
          "Téléphone: ":"Téléphone: ",
          "Numéro de la carte: ":"Numéro de la carte: ",
          "Entrer le numéro de votre carte":"Entrer le numéro de votre carte",
          ...
          "Code secret Flooz":"Code secret Flooz",
          "Vérifier les informations de l'entreprise.":"Vérifier les informations de l'entreprise.",
          "Code secret T-money":"Code secret T-money",
          "Mode de recharge":"Mode de recharge",
          "Rechager":"Rechager",
          
        },
        'en_US': {
          "Rechager":"Reload",
          "Mode de recharge":"Charging method",
          "Vérifier les informations de l'entreprise.":"Verify company information.",
          "Code secret T-money":"T-money secret code",
          "Code secret Flooz":"Flooz secret code",
          "Votre numéro de Téléphone":"Your phone number",
          "Téléphone de l'entreprise":"Company phone",
          "Entrer le montant":"Enter amount",
          "Entrer le numéro de votre carte":"Enter your card number",
          "Numéro de la carte: ":"Card number",
          "Téléphone: ":"Phone :",
          "Destinataire":"Recipient",
          "Taille (1 Mo)":"Size (1mo)",
